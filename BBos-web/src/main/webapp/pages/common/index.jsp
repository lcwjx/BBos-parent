    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#btnEp").click(function () {
                // 进行表单校验
                // var b = $("#updatePasswordFrom").form("validata");//判空
                if (true) {
                    //获取输入内容
                    ...
                    if (v1 == v2) {
                        ...
                        $.messager.alert("提示信息", "两次输入的密码不一致", "warning")
                    }
                } else {
...
<div id="editPwdWindow" class="easyui-window" title="修改密码" collapsible="false" minimizable="false" modal="true"
    ...
    <div class="easyui-layout" fit="true">
        <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
            <form id="updatePasswordFrom">
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input required="required" id="txtNewPass" type="Password"
                                   class="txt01 easyui-validatebox"/></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
                        <td><input required="required" id="txtRePass" type="Password" class="txt01 easyui-validatebox"/>
                        </td>
                    </tr>
                </table>
            </form>
