...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDelete() {
            ...
            if (rows.length == 0) {
                $.messager.alert("提示信息", "请选中条目", "warning")
            } else {
                //作废选中项
    ...
    <div region="center" style="overflow:auto;padding:5px;" border="false">
        <form id="addStaffFrom" action="staffAction_add.action" method="post">
            <table class="table-edit" width="80%" align="center">
                ...
                <%--<td>--%>
                <%----%>
                <%--<input type="text" name="id" class="easyui-validatebox" required="true"/></td>--%>
                <%--</tr>--%>
                <tr>
                    <td>姓名</td>
                    <td>
    ...
    <div region="center" style="overflow:auto;padding:5px;" border="false">
        <form id="editStaffFrom" action="staffAction_edit.action" method="post">
            <table class="table-edit" width="80%" align="center">
                ...
                <input type="hidden" name="id" class="easyui-validatebox" required="true"/></td>
                </tr>
                <tr>
                    <td>姓名</td>
                    <td>
